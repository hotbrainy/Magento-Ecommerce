...
class Infortis_Infortis_Model_System_Config_Source_Design_Section_SidePaddingValue
{
	public function toOptionArray()
	{
		return array(
			...
			array('value' => 'override',		'label' => Mage::helper('infortis')->__('Override Default Value...')),
		);
	}
}
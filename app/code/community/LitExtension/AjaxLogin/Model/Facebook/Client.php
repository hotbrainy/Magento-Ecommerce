...
class LitExtension_AjaxLogin_Model_Facebook_Client
{
    const REDIRECT_URI_ROUTE = 'ajaxlogin/facebook/connect';

    const XML_PATH_ENABLED = 'ajaxlogin/facebook/enabled';
    const XML_PATH_CLIENT_ID = 'ajaxlogin/facebook/api_key';
    const XML_PATH_CLIENT_SECRET = 'ajaxlogin/facebook/secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new LitExtension_Ajaxlogin_FacebookOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('ajaxlogin')
...
class LitExtension_Ajaxlogin_FacebookOAuthException extends Exception
{}
...
class Entangled_Bannerslider_Block_Bannerslider_Adminhtml_Banner_Edit_Tab_Form extends Magestore_Bannerslider_Block_Adminhtml_Banner_Edit_Tab_Form {
    ...
    protected function _prepareForm() {
        ...
        if (isset($data['mobile_image']) && $data['mobile_image']) {
            $imageName = Mage::helper('bannerslider')->reImageName($data['mobile_image']);
            $data['mobile_image'] = 'bannerslider' . '/' . $imageName;
        }
        $fieldset->addField('mobile_image', 'image', array(
            'label' => Mage::helper('bannerslider')->__('Mobile Banner Image'),
            'required' => false,
            'name' => 'mobile_image',
        ));
...
//        ));
        ...
        return call_user_func(array(get_parent_class(get_parent_class($this)), '_prepareForm'));
    }
}
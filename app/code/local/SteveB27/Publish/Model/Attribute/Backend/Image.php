...
class SteveB27_Publish_Model_Attribute_Backend_Image extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
    public function afterSave($object){
        ...
        $path = Mage::helper('publish/image')->getImageBaseDir();

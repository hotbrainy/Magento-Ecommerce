            ...
            if(typeof obj == 'string') {
                ...
                new Ajax.Request(url, {
                    ...
                    onSuccess	: function(response) {
                            ...
                            if(res) {
                                ...
                                if(res.configurable_options_block) {
                                    ...
                                    if(res.r == 'success') {
                                        ...
                                        //set cart to remain visible
                                        jQuery("#mini-cart-wrapper-regular").show();
                                        jQuery(".mini-cart-overlay").css({'opacity':0.9}).show();
                        ...
                        if(removeOverlay) jQuery("html").removeClass("has-overlay");
                    }
                });
            } else {
                            ...
                            try{
                                ...
                                if(res) {
                                    if(res.r == 'success') {
                                        ...
                                        jQuery('#excerptModal').modal('hide');

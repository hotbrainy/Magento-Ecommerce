...
class LitExtension_AjaxLogin_Model_Linkedin_Client
{
    const REDIRECT_URI_ROUTE = 'ajaxlogin/linkedin/connect';

    const XML_PATH_ENABLED = 'ajaxlogin/linkedin/enabled';
    const XML_PATH_CLIENT_ID = 'ajaxlogin/linkedin/api_key';
    const XML_PATH_CLIENT_SECRET = 'ajaxlogin/linkedin/secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new LitExtension_Ajaxlogin_LinkedinOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('ajaxlogin')
...
class LitExtension_Ajaxlogin_LinkedinOAuthException extends Exception
{}